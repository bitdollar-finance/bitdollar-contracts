...
// BTCD Token with Governance.
contract BTCDToken is BEP20('Bitdollars', 'BTCD') {
    using SafeMath for uint256;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "BTCD::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "BTCD::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "BTCD::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "BTCD::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "BTCD::_writeCheckpoint: block number exceeds 32 bits");
...
// File: contracts\BTCDMasterChef.sol
