...
// File: contracts/BTCDPoolInitializable.sol

pragma solidity 0.6.12;

contract BTCDPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public BTCD_POOL_FACTORY;
    ...
    function initialize(
        ...
        require(msg.sender == BTCD_POOL_FACTORY, "Not factory");
...
// File: contracts/BTCDPoolFactory.sol

pragma solidity 0.6.12;

contract BTCDPoolFactory is Ownable {
    event NewBTCDPoolContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(BTCDPoolInitializable).creationCode;
        bytes32 salt =
            keccak256(
        ...
        BTCDPoolInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewBTCDPoolContract(smartChefAddress);
    }
}
